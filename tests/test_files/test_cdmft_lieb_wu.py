"""Loop over chemical potential, reproducing analytic solution from
Lieb & Wu using a 1x4 cluster and two 4-orbital subbaths.
"""
...
model.set_target_sectors(
    [
        "R0:N6:S0/R0:N7:S-1/R0:N7:S1/R0:N8:S0/R0:N9:S-1/R0:N9:S1/R0:N10:S0",
        "R0:N6:S0/R0:N7:S-1/R0:N7:S1/R0:N8:S0/R0:N9:S-1/R0:N9:S1/R0:N10:S0",
    ]
)
