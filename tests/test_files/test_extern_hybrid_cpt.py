...
def Emery_model(oxygen=False, hybrid_file = None):
    ...
    Cu = pyqcm.cluster_model(4, name='Cu4')
    ...
    if oxygen:
        ...
        model = pyqcm.lattice_model('Cu4_O8', (clus_Cu, clus_O), ((4,0,0), (0,4,0)), ((2,0,0), (0,2,0)))
        ...
        model = pyqcm.lattice_model('Cu4', (clus_Cu,), ((4,0,0), (0,4,0)), ((2,0,0), (0,2,0)), hybrid_file=hybrid_file)
...
model.set_target_sectors(['N4:S0', 'N8:S0'])
