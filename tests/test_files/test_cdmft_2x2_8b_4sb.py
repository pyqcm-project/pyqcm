"""Test SB-CDMFT for the 2x2 plaquette hybridized with four 8-orbital
...
for sb_name, irrep in irreps.items():
    cluster_model = pyqcm.cluster_model(
        n_sites, n_baths, name="2x2_8b_{:s}".format(sb_name)
    )
...
model = pyqcm.lattice_model("2x2_8b_4sb", clus, [[2, 0, 0], [0, 2, 0]])
...
model.set_target_sectors(["R0:N12:S0", "R0:N12:S0", "R0:N12:S0", "R0:N12:S0"])
