...
static PyMethodDef methods[] = {
    ...
    {"density_matrix", density_matrix_python, METH_VARARGS,
     density_matrix_help},
    {"fidelity", fidelity_python, METH_VARARGS, fidelity_help},
    {"Green_function_average", Green_function_average_python, METH_VARARGS,
     Green_function_average_help},
    {"Green_function_density", Green_function_density_python, METH_VARARGS,
     Green_function_density_help},
    ...
    {"anomalous_operator", (PyCFunction)anomalous_operator_python,
     METH_VARARGS | METH_KEYWORDS, anomalous_operator_help},
    {"averages", averages_python, METH_VARARGS, averages_help},
    {"band_Green_function", band_Green_function_python, METH_VARARGS,
     band_Green_function_help},
    {"Berry_curvature", Berry_curvature_python, METH_VARARGS,
     Berry_curvature_help},
    {"Berry_flux", Berry_flux_python, METH_VARARGS, Berry_flux_help},
    {"CDMFT_distance", CDMFT_distance_python, METH_VARARGS,
     CDMFT_distance_help},
    {"CDMFT_host", CDMFT_host_python, METH_VARARGS, CDMFT_host_help},
    {"CDMFT_host_cumul", CDMFT_host_cumul_python, METH_VARARGS,
     CDMFT_host_cumul_help},
    {"set_CDMFT_host", set_CDMFT_host_python, METH_VARARGS,
     set_CDMFT_host_help},
    {"CDMFT_variational_set", CDMFT_variational_set_python, METH_VARARGS,
     CDMFT_variational_set_help},
    {"cluster_Green_function", cluster_Green_function_python, METH_VARARGS,
     cluster_Green_function_help},
    {"cluster_hopping_matrix", cluster_hopping_matrix_python, METH_VARARGS,
     cluster_hopping_matrix_help},
    {"cluster_info", cluster_info_python, METH_VARARGS, cluster_info_help},
    {"cluster_self_energy", cluster_self_energy_python, METH_VARARGS,
     cluster_self_energy_help},
    {"complex_HS", complex_HS_python, METH_VARARGS, complex_HS_help},
    {"CPT_Green_function_inverse", CPT_Green_function_inverse_python,
     METH_VARARGS, CPT_Green_function_inverse_help},
    {"CPT_Green_function", CPT_Green_function_python, METH_VARARGS,
     CPT_Green_function_help},
    {"density_wave", (PyCFunction)density_wave_python,
     METH_VARARGS | METH_KEYWORDS, density_wave_help},
    {"dispersion", dispersion_python, METH_VARARGS, dispersion_help},
    {"dos", dos_python, METH_VARARGS, dos_help},
    {"erase_model_instance", erase_model_instance_python, METH_VARARGS,
     erase_model_instance_help},
    {"explicit_operator", (PyCFunction)explicit_operator_python,
     METH_VARARGS | METH_KEYWORDS, explicit_operator_help},
    {"get_global_parameter", get_global_parameter_python, METH_VARARGS,
     get_global_parameter_help},
    {"get_CDMFT_host", get_CDMFT_host_python, METH_VARARGS,
     get_CDMFT_host_help},
    {"get_CDMFT_host_cumul", get_CDMFT_host_cumul_python, METH_VARARGS,
     get_CDMFT_host_cumul_help},
    {"great_reset", great_reset_python, METH_VARARGS, great_reset_help},
    {"Green_function_dimension", Green_function_dimension_python, METH_VARARGS,
     Green_function_dimension_help},
    {"Green_function_solve", Green_function_solve_python, METH_VARARGS,
     Green_function_solve_help},
    {"ground_state", ground_state_python, METH_VARARGS, ground_state_help},
    {"hopping_operator", (PyCFunction)hopping_operator_python,
     METH_VARARGS | METH_KEYWORDS, hopping_operator_help},
    {"hybridization_function", hybridization_function_python, METH_VARARGS,
     hybridization_function_help},
    {"hybridization_cumul", hybridization_cumul_python, METH_VARARGS,
     hybridization_cumul_help},
    {"interaction_operator", (PyCFunction)interaction_operator_python,
     METH_VARARGS | METH_KEYWORDS, interaction_operator_help},
    {"kinetic_energy", kinetic_energy_python, METH_VARARGS,
     kinetic_energy_help},
    {"lattice_model", lattice_model_python, METH_VARARGS, lattice_model_help},
    {"Lehmann_Green_function", Lehmann_Green_function_python, METH_VARARGS,
     Lehmann_Green_function_help},
    {"mixing", mixing_python, METH_VARARGS, mixing_help},
    {"model_size", model_size_python, METH_VARARGS, model_size_help},
    {"model_is_closed", model_is_closed_python, METH_VARARGS,
     model_is_closed_help},
    {"momentum_profile", momentum_profile_python, METH_VARARGS,
     momentum_profile_help},
    {"monopole", monopole_python, METH_VARARGS, monopole_help},
    {"new_model_instance", new_model_instance_python, METH_VARARGS,
     new_model_instance_help},
    ...
    {"instance_parameters", instance_parameters_python, METH_VARARGS,
     instance_parameters_help},
    {"periodized_Green_function_element",
     periodized_Green_function_element_python, METH_VARARGS,
     periodized_Green_function_element_help},
    {"periodized_Green_function", periodized_Green_function_python,
     METH_VARARGS, periodized_Green_function_help},
    {"potential_energy", potential_energy_python, METH_VARARGS,
     potential_energy_help},
    {"Potthoff_functional", Potthoff_functional_python, METH_VARARGS,
     Potthoff_functional_help},
    {"print_model", (PyCFunction)print_model_python,
     METH_VARARGS | METH_KEYWORDS, print_model_help},
    {"print_options", print_options_python, METH_VARARGS, print_options_help},
    {"print_parameter_set", print_parameter_set_python, METH_VARARGS,
     print_parameter_set_help},
    {"print_statistics", print_statistics_python, METH_VARARGS,
     print_statistics_help},
    {"projected_Green_function", projected_Green_function_python, METH_VARARGS,
     projected_Green_function_help},
    {"reduced_Green_function_dimension",
     reduced_Green_function_dimension_python, METH_VARARGS,
     reduced_Green_function_dimension_help},
    {"self_energy", self_energy_python, METH_VARARGS, self_energy_help},
    {"set_basis", set_basis_python, METH_VARARGS, set_basis_help},
    {"set_global_parameter", set_global_parameter_python, METH_VARARGS,
     set_global_parameter_help},
    {"set_parameter", set_parameter_python, METH_VARARGS, set_parameter_help},
    {"set_parameters", set_parameters_python, METH_VARARGS,
     set_parameters_help},
    {"set_target_sectors", set_target_sectors_python, METH_VARARGS,
     set_target_sectors_help},
    {"site_and_bond_profile", site_and_bond_profile_python, METH_VARARGS,
     site_and_bond_profile_help},
    {"spatial_dimension", spatial_dimension_python, METH_VARARGS,
     spatial_dimension_help},
    {"spectral_average", spectral_average_python, METH_VARARGS,
     spectral_average_help},
    {"switch_cluster_model", switch_cluster_model_python, METH_VARARGS,
     switch_cluster_model_help},
